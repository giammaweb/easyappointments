...
$lang['appointment_details_changed_message'] = 'Вашият час бе пренасочен. Ако новата дата или час не са удобни за Вас, можете да промените резервацията като използвате бутонът "Промяна / Отказ на час" в края на това електронно писмо.';
$lang['appointment_reschedule_cancel'] = 'Пренасрочи / Отмени срещата си';
