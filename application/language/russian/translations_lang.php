...
$lang['appointment_details_changed_message'] = 'Ваше назначение было переназначено. Если новая дата или время вам не подходят, вы можете свободно изменить бронирование, используя кнопку "Переназначить / Отменить назначение" внизу этого письма.';
$lang['appointment_reschedule_cancel'] = 'Изменить / Отменить запись на прием';
