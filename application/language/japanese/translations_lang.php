...
$lang['appointment_details_changed_message'] = '予約が再スケジュールされました。新しい日付や時間が合わない場合は、このメールの下部にある「予約の変更/キャンセル」ボタンを使用して、自由に予約を変更できます。';
$lang['appointment_reschedule_cancel'] = '予約の変更・キャンセル';
