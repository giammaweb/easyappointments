...
$lang['appointment_details_changed_message'] = 'Το ραντεβού σας έχει επαναπρογραμματιστεί. Αν η νέα ημερομηνία ή ώρα δεν σας εξυπηρετεί, μπορείτε να αλλάξετε ελεύθερα την κράτηση χρησιμοποιώντας το κουμπί "Επαναπρογραμματισμός / Ακύρωση Ραντεβού" στο κάτω μέρος αυτού του email.';
$lang['appointment_reschedule_cancel'] = 'Αναπρογραμματίστε / Ακυρώστε το ραντεβού σας';
